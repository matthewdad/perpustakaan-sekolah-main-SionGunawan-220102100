    ...
    <div class="min-h-screen flex items-center justify-center">
        <div class="container mx-auto">
            ...
            <div class="flex flex-col items-center mt-16">
                <h1 class="text-3xl font-semibold mb-6 text-center text-gray-800 dark:text-white">Selamat datang di Sistem Informasi Perpustakaan</h1>
                <h2 class="text-3xl font-semibold mb-6 text-red-400">{{ App\Models\Setting::first()->Stikom_Ambon }}</h2>
            ...
            <div class="flex justify-between items-center mt-16">
                <p class="text-sm text-gray-500">© {{ date('Y') }} Sistem Informasi Perpustakaan.</p>
